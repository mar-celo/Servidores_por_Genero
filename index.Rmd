...
grafico1 <- read_excel("dados/dados.xlsx", sheet = "Planilha7")|> janitor::clean_names()
...
A fonte primária para a obtenção das informações apresentadas é o Sistema Integrado de Administração de Pessoal (SIAPE) e o Painel Estatístico de Pessoal (PEP), no link: http://painel.pep.planejamento.gov.br.  

Outras fontes: 
 
- Convenção OIT: http://www.planalto.gov.br/ccivil_03/_Ato2019-2022/2019/Decreto/D10088.htm#art5  

-Banco Mundial: https://www.worldbank.org/pt/news/press-release/2019/02/27/despite-gains-women-face-setbacks-in-legal-rights-affecting-work 
...
Tel: (61) 2020-1179 
E-mail: sgp.cginf@economia.gov.br 
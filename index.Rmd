...
df <-  tabela2 %>% left_join(uf_sigla)  
  ...
  d3plusColor(value = "Perc_Feminino",
              heatmap = RColorBrewer::brewer.pal(n = 6, name = "Blues")) %>%
  d3plusText("uf") %>%
...
```{r dados_percentual-graficos, echo=FALSE, message=FALSE, warning=FALSE}
...
## Funções por Gêneros {.tabset .tabset-fade}

### 2015


```{r graf-2015, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r graf-2018, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r graf-2021, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r graf-2022, echo=FALSE, message=FALSE, warning=FALSE}
